...
- Run the task's verify command, the tests that cover the files you touched, and the gate checks (the coverage ratchet is one of them when `docs/PROJECT.md` §6 lists it).
